...
public final class AddTaskTest {
    ...
    private final AddTask add = new AddTask(linker, notifier);
    ...
    static Stream<Arguments> secondStateArgs() {
        return Stream.of(
                Arguments.of(new String[]{}, "Task added"),
                Arguments.of(new String[]{"Paradigmatic"}, "Task added"),
                Arguments.of(new String[]{"25.12.25"}, "Task added")
        );
    }
    ...
    void differentDatesTest(final String dateArg, final boolean valid)
        ...
        NumberedString answer = answerCaptor.getValue();
        assertEquals(1, answer.getNumber());
        assertEquals(valid, answer.getString().equals("Task added"));
    ...
    void endToEndTest() throws CommandException {
        ...
        NumberedString answer = answerCaptor.getValue();
        assertEquals(1, answer.getNumber());
        assertEquals("Task added", answer.getString());
        assertNull(resultState);
    }
    ...
    void overLimitTest() throws CommandException, UserNotFound {
        ...
        NumberedString answer = answerCaptor.getValue();
        assertEquals(1, answer.getNumber());
        assertEquals("You have used up all your task cells, please close one or "
                + "more tasks before add a new one.", answer.getString());
        assertNull(resultState);
    }
