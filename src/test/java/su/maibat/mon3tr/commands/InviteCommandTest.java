...
public final class InviteCommandTest {
    private final SQLiteLinker linker = Mockito.mock(SQLiteLinker.class);
    private final InviteCommand invite = new InviteCommand(linker);
    ...
    void withoutTest(final int inStateId, final int outStateId, final String answerText)
        ...
        State state = new State(inStateId, new String[]{}, invite);
        State resultState = invite.execute(1, new String[]{}, state, responseQueue);
    ...
    void withArgsTest(final int inStateId)
            throws UserNotFound {
        ...
        State resultState = invite.execute(1, new String[]{"1"}, state, responseQueue);
        ...
        NumberedString answer = answerCaptor.getValue();
        assertEquals(1, answer.getNumber());
        assertFalse(answer.getString().isEmpty());
