...
public final class UpdateOffsetCommandTest {
    ...
    private final UpdateOffsetCommand updateOffset = new UpdateOffsetCommand(linker, notifier);
    ...
    static Stream<Arguments> someArgs() {
        return Stream.of(
                ...
                Arguments.of(2, "Offset has been updated")
        );
    }
    ...
    void illegalOffsetTest(final String arg, final boolean valid)
        ...
        NumberedString answer = answerCaptor.getValue();
        assertEquals(1, answer.getNumber());
        assertEquals(valid, answer.getString().equals("Offset has been updated"));
