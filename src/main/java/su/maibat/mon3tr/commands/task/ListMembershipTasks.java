...
public class ListMembershipTasks implements Command {
    private static final int OFFSET = 1000;
    private final SQLiteLinker db;


    public ListMembershipTasks(final SQLiteLinker linker) {
        this.db = linker;
    }
    ...
    public String getHelp() {
        return "Lists tasks assigned to group in which you are a member";
    }
    ...
    protected State showDeadlines(final int userId, final String[] args, final State currentState,
        ...
        try {
            ...
            if (queryList.length == 0) {
                NumberedString answer = new NumberedString(userId, "There is no tasks");
                responseQueue.add(answer);
                return null;
            }
