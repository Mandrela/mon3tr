...
public class ListAssignedTasks implements Command {
    private static final int OFFSET = 1000;
    private final SQLiteLinker db;


    public ListAssignedTasks(final SQLiteLinker linker) {
        this.db = linker;
    }
    ...
    public String getHelp() {
        return "Lists tasks assigned to one of your owned groups";
    }
