...
public final class RegisterCommand implements StatelessCommand {
    private final DataBaseLinker db;
    private final Map<Integer, Long> tempIds;

    public RegisterCommand(final DataBaseLinker dataBase, final Map<Integer, Long> idMap) {
        db = dataBase;
        tempIds = idMap;
    }
    ...
    public String getHelp() {
        return "Registrates you in system";
    }
